<template>
    <div class="flex flex-col flex-1 items-center ">
      ...
      <div v-if="route.query.preview" class="text-white  bg-weather-secondary w-full text-center p-4">
        <p> You are currently preview this city, click the "+" icon to start tracking other city.</p>
      </div>
      <div class="flex flex-col items-center text-white py-12 ">
        ...
        <p class=" text-8xl mb-8">
          ...
          <img class="w-[150] h-aotu" :src="`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@2x.png`" alt="">
